...
void estimated_sfc_precip1_(int *i, float *pRate1d, float *pRateStd1d,
			    float *sfcRain, 
			    int *sfc, int *bzd, int *cfb, int *ptype, 
			    float *liqFract,int *badRayFlag)
{
  ...
  if(*badRayFlag!=0)
    {
      ...
      swathx.KuGMI.estimSurfPrecipLiqRate[*i]=missing_r4c;
      swathx.KuGMI.estimSurfPrecipTotRateSigma[*i]=missing_r4c;
      swathx.KuGMI.FLG.estimPrecipInClutter[*i]=missing_i2c;
    }  
  //printf("%i %i \n",  swathx.KuGMI.lowestEstimateBin[*i],swathx.KuGMI.phaseBinNodes[*i][4]);
...
void estimated_sfc_precip1_t_(int *i, float *pRate1d, float *pRateStd1d, 
			      float *sfcRain, 
			      int *sfc, int *bzd, int *cfb, int *ptype, 
			      float *liqFract, int *badRayFlag)
{
  ...
  if(*badRayFlag!=0)
    {
      ...
      swath_t.KuTMI.estimSurfPrecipLiqRate[*i]=missing_r4c;
      swath_t.KuTMI.estimSurfPrecipTotRateSigma[*i]=missing_r4c;
      swath_t.KuTMI.FLG.estimPrecipInClutter[*i]=missing_i2c;
    }  
