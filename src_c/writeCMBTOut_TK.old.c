...
L2BCMB_SWATHS_cs2 swath1;
L2ADPR_SWATHS_db1 dprswathT;
...
{
  int i;
  extern L2BCMB_SWATHS_cs2 swath1;
...
{
  int i;
  //  extern L2BCMB_SWATHS_cs22 swath;
...
{
  int k;
  extern L2ADPR_SWATHS_db1 dprswathT;
...
{
  int k;
  //extern L2BCMB_SWATHS_cs2 swath;
  //for(k=0;k<10;k++)
