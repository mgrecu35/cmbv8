...
do j=1,dPRData%n1c21
   if(ialg==1) then
      do i=1,25
         ...
         !call copyw10small_300(j-1,w10_out_MS(i+12,j),i-1) !SJM 12/9/2014
         !call copyw10smallsigma_300(j-1,w10_rms_MS(i+12,j),i-1) !SJM 12/9/2014
      enddo
   endif
   if(ialg==2) then
      call setlatlons1t( dPRData%xlat(:,j), dPRData%xlon(:,j),                &
           sfcRain(:,j),sfcRainStd(:,j),piaOut(:,j))
      !call setlatlons1t_300(j-1, dPRData%xlat(:,j), dPRData%xlon(:,j),                &
      !     sfcRain(:,j),sfcRainStd(:,j),piaOut(:,j))
   else
      ...
      !--300--!
      !call setlatlons1_300(j-1, dPRData%xlat(:,j), dPRData%xlon(:,j),                &
      !     sfcRain(:,j),sfcRainStd(:,j),piaOut(:,j))
      !call setlatlons2_300(j-1, dPRData%xlat(:,j), dPRData%xlon(:,j),                 &
      !     sfcRainMS(:,j),sfcRainStdMS(:,j),piaOutKuMS(:,j),piaOutKaMS(:,j))
   ...
   do i=1,49
      if(ialg==1) then
         ...
         !--300--!
         !call copyrainflags1_300(j-1,dPRData%rainFlagBad(i,j), i-1)
         !call copyioqualitys1_300(j-1,dPRData%ioqualityflagku(i,j), i-1)
         !call copysnowices1_300(j-1,dPRData%snowIceCover(i,j), i-1)
         !call copyinitnws1_300(j-1,initnw_NS(:, i, j), dPRRet%n9(:, i, j), i-1)
         !call copyprincomps1_300(j-1,princomp_NS(:, i, j), i-1)
         !call copyprofclasss1_300(j-1,profclass_NS(i, j), i-1)
         !call copysurfprecipbiasratios1_300(j-1,surfprecipbiasratio_NS(i, j), i-1)
         !call copysubfootvariabilitys1_300(j-1,subfootvariability_NS(i, j), i-1)
         !call copymultiscatcalcs1_300(j-1,multiscatcalc_NS(i, j), i-1)
         !call copymultiscatsurfaces1_300(j-1,multiscatsurface_NS(i, j), i-1)
         !end    WSO 2/8/17
      else
         ...
         !--300--!
         !call copymultiscatsurfaces1t_300(j-1,multiscatsurface_NS(i, j), i-1)
         !call copyrainflags1t_300(j-1,dPRData%rainFlagBad(i,j), i-1)
         !call copyioqualitys1t_300(j-1,dPRData%ioqualityflagku(i,j), i-1)
         !call copysnowices1t_300(j-1,dPRData%snowIceCover(i,j), i-1)
         !call copyinitnws1t_300(j-1,initnw_NS(:, i, j), dPRRet%n9(:, i, j), i-1)
         !call copyprincomps1t_300(j-1,princomp_NS(:, i, j), i-1)
         !call copyprofclasss1t_300(j-1,profclass_NS(i, j), i-1)
         !call copysurfprecipbiasratios1t_300(j-1,surfprecipbiasratio_NS(i, j), i-1)
         !call copysubfootvariabilitys1t_300(j-1,subfootvariability_NS(i, j), i-1)
         !call copymultiscatcalcs1t_300(j-1,multiscatcalc_NS(i, j), i-1)
         !call copymultiscatsurfaces1t_300(j-1,multiscatsurface_NS(i, j), i-1)
      endif
      ...
      if(ialg==2) then
         ...
         !--300--!
         !call copysigmapias1t_300(j-1,dPRData%srtsigmaPIAku(i, j), i-1)
         !call copysigmazeros1t_300(j-1,dPRData%sigmaZeroKu(i, j), i-1)
      else
         call copysigmapias1(dPRData%srtsigmaPIAku(i, j), i-1)
         call copysigmazeros1(dPRData%sigmaZeroKu(i, j), i-1)
         !--300--!
         !call copysigmapias1_300(j-1,dPRData%srtsigmaPIAku(i, j), i-1)
         !call copysigmazeros1_300(j-1,dPRData%sigmaZeroKu(i, j), i-1)
      endif
...
!end    WSO 9/17/13
      ...
      if(ialg==2) then
         ...
         !--300--!
         !call copycldices1t_300(j-1,cldiprof,i-1)
         !call copyrrates1t_300(j-1,rrate3D(:,i,j),rrate3Dstd(:,i,j),i-1)
         !call copypwcs1t_300(j-1,pwc3D(:,i,j),pwc3Dstd(:,i,j),i-1)
         !call copylwcfracs1t_300(j-1,mlwc_frac(:,i,j),mrate_frac(:,i,j),i-1)
         !call copysfcrainliqfracs1t_300(j-1,sfcRainLiqFrac(i, j), i-1)
         !call copyd0s1t_300(j-1,d03D(:,i,j),i-1)
         !call copyzckus1t_300(j-1,zcKu3D(:,i,j),i-1)
         !call copynodess1t_300(j-1,dPRData%node(:,i,j),i-1)
      else
         ...
         !--300--!
         !call copycldwaters1_300(j-1,cldwprof,i-1)
         cldiprof = missing_r4
         !call copycldices1_300(j-1,cldiprof,i-1)
         !call copyrrates1_300(j-1,rrate3D(:,i,j),rrate3Dstd(:,i,j),i-1)
         !call copypwcs1_300(j-1,pwc3D(:,i,j),pwc3Dstd(:,i,j),i-1)
         !call copylwcfracs1_300(j-1,mlwc_frac(:,i,j),mrate_frac(:,i,j),i-1)
         !call copysfcrainliqfracs1_300(j-1,sfcRainLiqFrac(i, j), i-1)
         !call copyd0s1_300(j-1,d03D(:,i,j),i-1)
         !call copyzckus1_300(j-1,zcKu3D(:,i,j),i-1)
         !call copynodess1_300(j-1,dPRData%node(:,i,j),i-1)
      endif
...
!end    WSO 8/19/13
      ...
      if(ialg==2) then 
         ...
         !--300--!
         !call copylognws1t_300(j-1, log10NwMean,dPRRet%n9(:,i,j),i-1)
         !call copymus1t_300(j-1, mu_mean_prof, dPRRet%n9(:,i,j),i-1)
         !call copypreciptypet_300(j-1,dPRData%raintype(i,j),i-1)
         !call copyw10t_300(j-1,w10_out_NS(i,j),i-1) !modified SJM 12/4/2014
         !call copyw10sigmat_300(j-1,w10_rms_NS(i,j),i-1) !modified SJM 12/4/2014
         !call copyenvtemps1t_300(j-1,dPRData%envTemp(:,i,j),env_nodes(:,i),i-1)
         !call copysfcairtemps1t_300(j-1,dPRData%envSfcTemp(i,j),i-1)
         !call copyenvpresss1t_300(j-1,dPRData%envPress(:,i,j),env_nodes(:,i),i-1)
         !call copysfcairpresss1t_300(j-1,dPRData%envSfcPress(i,j),i-1)
         !call copyenvqvs1t_300(j-1,dPRData%envQv(:,i,j),env_nodes(:,i),i-1)
         !call copyenvsfqvs1t_300(j-1,dPRData%envQv(:,i,j),i-1)
         !call copyskintemps1t_300(j-1,dPRData%envSknTemp(i,j),i-1)
         !call copyskintempsigmas1t_300(j-1,skintempsigma_NS(i, j), i-1)
         !call copycolumnvaporsigmas1t_300(j-1,columnvaporsigma_NS(i, j), i-1)
         !call copycolumncloudliqsigmas1t_300(j-1,columncloudliqsigma_NS(i, j), i-1)
         !call copyalgotypes1t_300(j-1,algotype_NS(i, j), i-1)
         !call copyerrorofdatafits1t_300(j-1,errorofdatafit_NS(i, j), i-1)
      else
         ...
         !--300-!
         !call copylognws1_300(j-1, log10NwMean,dPRRet%n9(:,i,j),i-1)
         !call copymus1_300(j-1, mu_mean_prof, dPRRet%n9(:,i,j),i-1)
         !call copypreciptype_300(j-1,dPRData%raintype(i,j),i-1)
         !call copyw10_300(j-1,w10_out_NS(i,j),i-1) !modified SJM 12/4/2014
         !call copyw10sigma_300(j-1,w10_rms_NS(i,j),i-1) !modified SJM 12/4/2014
         !call copyenvtemps1_300(j-1,dPRData%envTemp(:,i,j),env_nodes(:,i),i-1)
         !call copysfcairtemps1_300(j-1,dPRData%envSfcTemp(i,j),i-1)
         !call copyenvpresss1_300(j-1,dPRData%envPress(:,i,j),env_nodes(:,i),i-1)
         !call copysfcairpresss1_300(j-1,dPRData%envSfcPress(i,j),i-1)
         !call copyenvqvs1_300(j-1,dPRData%envQv(:,i,j),env_nodes(:,i),i-1)
         !call copyenvsfqvs1_300(j-1,dPRData%envQv(:,i,j),i-1)
         !call copyskintemps1_300(j-1,dPRData%envSknTemp(i,j),i-1)
         !call copyskintempsigmas1_300(j-1,skintempsigma_NS(i, j), i-1)
         !call copycolumnvaporsigmas1_300(j-1,columnvaporsigma_NS(i, j), i-1)
         !call copycolumncloudliqsigmas1_300(j-1,columncloudliqsigma_NS(i, j), i-1)
         !call copyalgotypes1_300(j-1,algotype_NS(i, j), i-1)
         !call copyerrorofdatafits1_300(j-1,errorofdatafit_NS(i, j), i-1)
...
!end    WSO 6/5/18 
      if(ialg==2) then
         ...
         !--300--!
         !call copysfcemissouts1t_300(j-1,emissoutL(i,j,:),i-1)
         !call copysfcemissouts1sigmat_300(j-1,emis_rms_NS(i,j,:),i-1)
      else
         call copysfcemissouts1(emissoutL(i,j,:),i-1)
         call copysfcemissouts1sigma(emis_rms_NS(i,j,:),i-1)
         !--300--!
         !call copysfcemissouts1_300(j-1,emissoutL(i,j,:),i-1)
...
!begin  WSO 9/28/13 add rain flag including missing for bad scans
        ...
        !call copyrainflags2_300(j-1,dPRData%rainFlagBad(i,j), i-13)
        !call copyioqualitys2_300(j-1,dPRData%ioqualityflagdpr(i,j), i-13)
        !call copysnowices2_300(j-1,dPRData%snowIceCover(i,j), i-13)
        !call copyinitnws2_300(j-1,initnw_MS(:, i, j), dPRRet%n9(:, i, j), i-13)
        !call copyprincomps2_300(j-1,princomp_MS(:, i, j), i-13)
        !call copyprofclasss2_300(j-1,profclass_MS(i, j), i-13)
        !call copysurfprecipbiasratios2_300(j-1,surfprecipbiasratio_MS(i, j), i-13)
        !call copysubfootvariabilitys2_300(j-1,subfootvariability_MS(i, j), i-13)
        !call copymultiscatcalcs2_300(j-1,multiscatcalc_MS(i, j), i-13)
        !call copymultiscatsurfaces2_300(j-1,multiscatsurface_MS(i, j), i-13)
        !call copycldwaters2_300(j-1,cldwprof, i-13)
        cldiprof = missing_r4
        !call copycldices2_300(j-1,cldiprof,i-13)
        !call copyzckus2_300(j-1,zcKu3DMS(:,i,j), zcKa3DMS(:,i,j), i-13)
        !call copysigmapias2_300(j-1,dPRData%dsrtsigmaPIAku(i, j), dPRData%dsrtsigmaPIAka(i, j), i-13)
        !call copysigmazeros2_300(j-1,dPRData%sigmaZeroKu(i, j), dPRData%sigmaZeroKa(i, j), i-13)
...
!end     WSO 8/19/13
         ...
         !--300--!
         !call copylognws2_300(j-1, log10NwMean,dPRRet%n9(:,i,j),i-13)
         !call copymus2_300(j-1, mu_mean_prof,dPRRet%n9(:,i,j),i-13)
         !call copyrrates2_300(j-1,rrate3DMS(:,i,j),rrate3DstdMS(:,i,j),i-13)
         !call copypwcs2_300(j-1,pwc3DMS(:,i,j),pwc3DstdMS(:,i,j),i-13)
         !call copylwcfracs2_300(j-1,mlwc_fracMS(:,i,j),mrate_fracMS(:,i,j),i-13)
         !call copysfcrainliqfracs2_300(j-1,sfcRainLiqFracMS(i, j), i-13)
         !call copyd0s2_300(j-1,d03DMS(:,i,j),i-13)
         !call copynodess2_300(j-1,dPRData%node(:,i,j),i-13)
         !call copyenvtemps2_300(j-1,dPRData%envTemp(:,i,j), env_nodes(:,i), i-13)
         !call copysfcairtemps2_300(j-1,dPRData%envSfcTemp(i,j),i-13)
         !call copyenvpresss2_300(j-1,dPRData%envPress(:,i,j), env_nodes(:,i), i-13)
         !call copysfcairpresss2_300(j-1,dPRData%envSfcPress(i,j),i-13)
         !call copyenvqvs2_300(j-1,dPRData%envQv(:,i,j), env_nodes(:,i), i-13)
         !call copyenvsfqvs2_300(j-1,dPRData%envQv(:,i,j),i-13)
         !call copyskintemps2_300(j-1,dPRData%envSknTemp(i,j),i-13)
         !call copyskintempsigmas2_300(j-1,skintempsigma_MS(i, j), i-13)
         !call copycolumnvaporsigmas2_300(j-1,columnvaporsigma_MS(i, j), i-13)
         !call copycolumncloudliqsigmas2_300(j-1,columncloudliqsigma_MS(i, j), i-13)
         !call copyalgotypes2_300(j-1,algotype_MS(i, j), i-13)
         !call copyerrorofdatafits2_300(j-1,errorofdatafit_MS(i, j), i-13)
...
!end    WSO 10/14/15
         ...
         !--300--!
         !call copysfcemissouts2_300(j-1,emissoutL(i,j,:),i-13)
         !call copysfcemissouts2sigma_300(j-1,emis_rms_MS(i,j,:),i-13)
      endif
      ...
      if(ialg==2) then
         ...
         !call copytbouts1t_300(j-1,tbout,i-1)
      else
         call copytbouts1(tbout,i-1)
         !--300--!
         !call copytbouts1_300(j-1,tbout,i-1)
      endif
!!begin MG 09172013
      if(i>12 .and. i<38) then
         ...
         !--300--!
         !call copytbouts2_300(j-1,tbout,i-13)
      endif
!!end MG 09172013
   enddo
   ...
   if(ialg==2) then
      ...
      !--300--!
      !call frominputt_300(j-1,st_2adpr)
      !call copyscantimet_300(j-1,j-1)
      call writescant()
   else
      ...
      !--300--!
      !call frominput_300(j-1,st_2adpr)
      !call copyscantime_300(j-1,j-1)
      !--300--!
      call writescan()
   endif
